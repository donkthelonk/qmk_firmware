 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | GUI  | Alt  |Space |Lower |Raise |Space | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LGUI, KC_LALT, KC_SPC,  LOWER,   RAISE,   KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_ADJUST] = {
  ...
  {_______, RESET,  _______,  _______, FC_TOG, _______, _______, _______, _______,_______, _______, _______},
